...
Prism.languages.markup && (Prism.hooks.add("before-highlight", function(a) {
  ...
  if ("php" === a.language) {
    for (var b = 0, c; c = a.tokenStack[b]; b++)
      a.highlightedCode = a.highlightedCode.replace("{{{PHP" + (b + 1) + "}}}", Prism.highlight(c, a.grammar, "php"));
    ...
    o.onreadystatechange = function() {
      if (o.readyState == 4)
        if (o.status < 400 && o.responseText) {
          ...
          o.status >= 400 ? s.textContent = "✖ Error " + o.status + " while fetching file: " + o.statusText : s.textContent = "✖ Error: File does not exist or is empty"
    };
    o.send(null)
  })
})();
