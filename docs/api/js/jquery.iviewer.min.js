...
(function($, undefined) {
  ...
  $.widget("ui.iviewer", $.ui.mouse, {widgetEventPrefix: "iviewer", options: {zoom: "fit", zoom_base: 100, zoom_max: 800, zoom_min: 25, zoom_delta: 1.4, zoom_animation: true, ui_disabled: false, mousewheel: true, update_on_resize: true, onZoom: jQuery.noop, onAfterZoom: jQuery.noop, onStartDrag: jQuery.noop, onDrag: jQuery.noop, onStopDrag: jQuery.noop, onMouseMove: jQuery.noop, onClick: jQuery.noop, onStartLoad: null, onFinishLoad: null, onErrorLoad: null},
    ...
    _correctCoords: function(x, y) {
      ...
      if (this.img_object.display_height() <= this.options.height)
        y = -(this.img_object.display_height() -
    ...
    zoom_by: function(delta, zoom_center) {
      ...
      var rate = 1;
      while (Math.abs(func(this.options.zoom_base, Math.pow(mltplr, rate)) - value) > Math.abs(func(this.options.zoom_base, Math.pow(mltplr, rate + 1)) - value))
        rate++;
      return sgn * rate
      ...
      switch (param) {
        ...
        case "orig_height":
          if (withoutRotation)
            return this.img_object.angle() %
                    180 === 0 ? this.img_object[param]() : param === "orig_width" ? this.img_object.orig_height() : this.img_object.orig_width();
          else
  ...
  (function() {
    ...
    this.setImageProps = function(disp_w, disp_h, x, y, skip_animation, complete) {
      ...
      if (useIeTransforms)
        jQuery.extend(params, {marginLeft: ieTransforms[this.angle()].marginLeft * this.display_diff() / 2, marginTop: ieTransforms[this.angle()].marginTop * this.display_diff() / 2});
      ...
      if (this._do_anim && !skip_animation)
        this._img.stop(true).animate(params, {duration: 200, complete: complete, step: function(now, fx) {
