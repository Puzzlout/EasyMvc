...
  /**    * Sets f_account_active if the value passed match the type expected, otherwise throws an exception.  */  public function setF_account_active($f_account_active) {      $this->f_account_active = $f_account_active;  }
  /**    * Sets f_account_visible if the value passed match the type expected, otherwise throws an exception.  */  public function setF_account_visible($f_account_visible) {      $this->f_account_visible = $f_account_visible;  }
