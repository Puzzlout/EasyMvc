...
  /**    * Sets f_log_id if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_id($f_log_id) {      $this->f_log_id = $f_log_id;  }
  /**    * Sets f_log_request_id if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_request_id($f_log_request_id) {      $this->f_log_request_id = $f_log_request_id;  }
  /**    * Sets f_log_start if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_start($f_log_start) {      $this->f_log_start = $f_log_start;  }
  /**    * Sets f_log_end if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_end($f_log_end) {      $this->f_log_end = $f_log_end;  }
  /**    * Sets f_log_execution_time if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_execution_time($f_log_execution_time) {      $this->f_log_execution_time = $f_log_execution_time;  }
  /**    * Sets f_log_type if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_type($f_log_type) {      $this->f_log_type = $f_log_type;  }
  /**    * Sets f_log_filter if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_filter($f_log_filter) {      $this->f_log_filter = $f_log_filter;  }
  /**    * Sets f_log_value if the value passed match the type expected, otherwise throws an exception.  */  public function setF_log_value($f_log_value) {      $this->f_log_value = $f_log_value;  }
