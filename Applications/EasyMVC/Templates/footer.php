<?php if (!defined('__EXECUTION_ACCESS_RESTRICTION__')) exit('No direct script access allowed'); ?>
      ...
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/addons/toastr.js"></script>  
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/addons/jquery.parseParams.js"></script>  
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/addons/jquery.contextMenu.js"></script>  
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/addons/jquery.ui.position.js"></script>  
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/addons/spin.min.js"></script>  
      ...
      <script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/js/app/controllers/tabs.js"></script>
