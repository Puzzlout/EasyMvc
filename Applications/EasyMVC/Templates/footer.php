...
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/addons/toastr.js"></script>  
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/addons/jquery.parseParams.js"></script>  
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/addons/jquery.contextMenu.js"></script>  
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/addons/jquery.ui.position.js"></script>  
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/addons/spin.min.js"></script>  
...
<script type="application/javascript" src="<?php echo $this->app->relative_path; ?>Applications/<?php echo __APPNAME__; ?>/ClientSide/js/app/controllers/tabs.js"></script>
