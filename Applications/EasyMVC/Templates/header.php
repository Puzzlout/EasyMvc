...
<html lang="<?php echo $this->app->locale; ?>">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/css/app/reset.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $this->app->relative_path; ?>Web/library/css/core/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/css/addons/toastr.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $this->app->relative_path; ?>Applications/EasyMvc/ClientSide/css/addons/jquery.contextMenu.css" />
