...
<section  class="login-container">
  <figure class="login-box">
    <h1><?php echo $ViewModel->Resx->GetValue(AccountResx::h1_title); ?></h1>
    <div class="login-form login-box-small">
      <p style="display: none;">
        <label><?php echo $ViewModel->Resx->GetValue(AccountResx::email_label); ?></label>
        <input 
          autocomplete="on" 
          name="f_user_email" 
          type="text" 
      ...
      <label><?php echo $ViewModel->Resx->GetValue(AccountResx::username_label); ?></label>
      <input 
        autocomplete="on" 
        name="f_user_login" 
        type="text" 
        class="field" 
        data-input-label="<?php echo $ViewModel->Resx->GetValue(AccountResx::username_label); ?>" 
        placeholder="<?php echo $ViewModel->Resx->GetValue(AccountResx::username_ph_text); ?>">
      </p>
      <label><?php echo $ViewModel->Resx->GetValue(AccountResx::pwd_label); ?></label>
      <input 
        autocomplete="on" 
        name="f_user_password" 
        type="password" 
        class="field" 
        data-input-label="<?php echo $ViewModel->Resx->GetValue(AccountResx::pwd_label); ?>" 
        placeholder="<?php echo $ViewModel->Resx->GetValue(AccountResx::pwd_ph_text); ?>">
      </p>
