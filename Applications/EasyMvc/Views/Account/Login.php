  ...
  <figure class="login-box">
    ...
    <div class="login-form login-box-small">
      <p style="display: none;">
        ...
        <input autocomplete="on" name="f_user_email" type="text" class="field" data-input-label="<?php echo $resx["email_label"]; ?>" placeholder="<?php echo $resx["email_ph_text"]; ?>">
      </p>
        <label><?php echo $resx["username_label"]; ?></label>
        <input autocomplete="on" name="f_user_login" type="text" class="field" data-input-label="<?php echo $resx["username_label"]; ?>" placeholder="<?php echo $resx["username_ph_text"]; ?>">
      </p>
        <label><?php echo $resx["pwd_label"]; ?></label>
        <input autocomplete="on" name="f_user_password" type="password" class="field" data-input-label="<?php echo $resx["pwd_label"]; ?>" placeholder="<?php echo $resx["pwd_ph_text"]; ?>">
      </p>
